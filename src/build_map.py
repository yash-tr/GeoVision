...
flight_zone = FlightZone(17.597029, 78.119958, 17.585345, 78.125000)

#define as height (latitude) and width (longitude) of the patch to be taken
patch_size = PatchSize(0.001676, 0.002)
...
for i in range(0, height):
    for j in range(0, width):
        ...
        if r.status_code == 200:
            ...
            print("Error " + str(r.status_code) + " downloading image " + str(index))
